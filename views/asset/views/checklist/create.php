  ...
  <div class="row justify-content-center">
    ...
    <div class="col-xl-12">
      <div class="card shadow">
        ...
        <div class="card-body">
          <form action="/asset/checklist/create" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
            <div class="row mb-2">
            ...
            <div class="row mb-2">
              ...
              <div class="col-xl-2 col-md-4 pt-2">
                <input class="form-check-input" type="radio" name="type" id="subject" value="1" required>
                <label class="form-check-label" for="subject">
                  <span class="text-primary">หัวข้อ</span>
                </label>
              </div>
              <div class="col-xl-2 col-md-4 pt-2">
                <input class="form-check-input" type="radio" name="type" id="text" value="2" required>
            ...
            <div class="row div_reference">
              <label class="col-xl-4 col-md-4 col-form-label text-xl-end">อ้างอิง (หัวข้อ)</label>
              <div class="col-xl-4 col-md-6">
