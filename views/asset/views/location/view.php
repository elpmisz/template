  ...
  <div class="row justify-content-center">
    ...
    <div class="col-xl-12">
      <div class="card shadow">
        ...
        <div class="card-body">
          <form action="/asset/location/update" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <div class="row justify-content-center mb-2">
              ...
              <div class="col-xl-3 col-md-6 mb-2">
                <a href="/asset/location" class="btn btn-danger btn-sm w-100">
